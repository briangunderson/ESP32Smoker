...
|---------|-----|-------------|
| **Cribl** | http://192.168.1.97:9000/ | user: claude<br>pass: CiEtiNc65!k@gCG |
| **Kibana** | http://192.168.1.97:5601/ | user: elastic<br>pass: N5l2MV3c |
| **Elasticsearch** | http://192.168.1.97:9200/ | user: elastic<br>pass: N5l2MV3c |

### Key Endpoints

- **Dashboard:** http://192.168.1.97:5601/app/dashboards#/view/esp32-dashboard
- **Discover:** http://192.168.1.97:5601/app/discover
- **Cribl Live Data:** http://192.168.1.97:9000/monitoring/live-data
...
#    Update code to send syslog to 192.168.1.97:9514
