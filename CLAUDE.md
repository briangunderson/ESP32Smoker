...
- **OTA_PASSWORD**: Pass `OTA_PASSWORD=smoker2026` as env var for OTA uploads (not stored in platformio.ini for security)
...
```bash
OTA_PASSWORD=your-password pio run --target upload --upload-port 10.10.63.242
```
...
**Access Points:**
- Cribl: http://192.168.1.97:9000/ (user: claude)
- Kibana Dashboard: http://192.168.1.97:5601/app/dashboards
- Elasticsearch: http://192.168.1.97:9200/
