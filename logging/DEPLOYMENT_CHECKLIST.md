...
### Prerequisites
- [ ] Cribl Stream installed and running on 192.168.1.97:9000
- [ ] Elasticsearch installed and running on 192.168.1.97:9200
- [ ] Kibana installed and running on 192.168.1.97:5601
...
- [ ] Cribl password: CiEtiNc65!k@gCG
- [ ] Elasticsearch username: elastic
- [ ] Elasticsearch password: N5l2MV3c
...
curl -u elastic:N5l2MV3c http://192.168.1.97:9200/_index_template/esp32-logs

# Check ingest pipeline
curl -u elastic:N5l2MV3c http://192.168.1.97:9200/_ingest/pipeline/esp32-syslog-pipeline

# List indices
curl -u elastic:N5l2MV3c http://192.168.1.97:9200/_cat/indices/esp32-logs-*?v
```
...
curl -u elastic:N5l2MV3c \
  http://192.168.1.97:5601/api/saved_objects/index-pattern/esp32-logs-pattern

# List visualizations
curl -u elastic:N5l2MV3c \
  http://192.168.1.97:5601/api/saved_objects/_find?type=visualization

# Check dashboard
curl -u elastic:N5l2MV3c \
  http://192.168.1.97:5601/api/saved_objects/dashboard/esp32-dashboard
```

**Manual verification:**
- [ ] Open Kibana in browser: http://192.168.1.97:5601
...
```bash
# Check watchers
curl -u elastic:N5l2MV3c http://192.168.1.97:9200/_watcher/stats?pretty

# List all watchers
curl -u elastic:N5l2MV3c "http://192.168.1.97:9200/_watcher/watch/_all" | grep -o '"_id":"[^"]*"'

# Check alerts index
curl -u elastic:N5l2MV3c http://192.168.1.97:9200/_cat/indices/esp32-alerts?v
```
...
- [ ] Navigate to Cribl: http://192.168.1.97:9000
...
- [ ] Add Elasticsearch destination
  ...
  - URL: http://192.168.1.97:9200
  - Auth: Basic (elastic / N5l2MV3c)
...
# Count documents
curl -u elastic:N5l2MV3c \
  "http://192.168.1.97:9200/esp32-logs-*/_count?pretty"

# Should return count > 0

# View sample documents
curl -u elastic:N5l2MV3c \
  "http://192.168.1.97:9200/esp32-logs-*/_search?pretty&size=5&sort=@timestamp:desc"
```
...
- [ ] Open dashboard: http://192.168.1.97:5601/app/dashboards
...
#define SYSLOG_SERVER "192.168.1.97"
...
curl -u elastic:N5l2MV3c \
  -X DELETE http://192.168.1.97:9200/_index_template/esp32-logs

# Delete ingest pipeline
curl -u elastic:N5l2MV3c \
  -X DELETE http://192.168.1.97:9200/_ingest/pipeline/esp32-syslog-pipeline

# Delete indices
curl -u elastic:N5l2MV3c \
  -X DELETE "http://192.168.1.97:9200/esp32-logs-*"

# Delete watchers
curl -u elastic:N5l2MV3c \
  -X DELETE http://192.168.1.97:9200/_watcher/watch/esp32-error-state
...
# Delete dashboard
curl -u elastic:N5l2MV3c \
  -X DELETE http://192.168.1.97:5601/api/saved_objects/dashboard/esp32-dashboard

# Delete visualizations
curl -u elastic:N5l2MV3c \
  -X DELETE "http://192.168.1.97:5601/api/saved_objects/visualization/esp32-viz-*"

# Delete index pattern
curl -u elastic:N5l2MV3c \
  -X DELETE http://192.168.1.97:5601/api/saved_objects/index-pattern/esp32-logs-pattern
```
