...
6. **Configure ESP32** (5 minutes)
   - Set syslog host: YOUR-LOGGING-SERVER-IP:9514
   - Format: RFC 5424
   - Device/app names
...
**View Logs:**
- Dashboard: http://YOUR-LOGGING-SERVER-IP:5601/app/dashboards
...
# Recent errors
curl -u elastic:YOUR-ELASTIC-PASSWORD \
  "http://YOUR-LOGGING-SERVER-IP:9200/esp32-logs-*/_search?q=severity:error&pretty"
```
...
│  (RFC 5424)     │ to YOUR-LOGGING-SERVER-IP:9514
└────────┬────────┘
         │
         ▼
┌─────────────────┐
...
- **Cribl**: http://YOUR-LOGGING-SERVER-IP:9000/ (user: claude, pass: YOUR-CRIBL-PASSWORD)
- **Kibana**: http://YOUR-LOGGING-SERVER-IP:5601/ (user: elastic, pass: YOUR-ELASTIC-PASSWORD)
- **Elasticsearch**: http://YOUR-LOGGING-SERVER-IP:9200/ (user: elastic, pass: YOUR-ELASTIC-PASSWORD)
...
# Check logs
curl -u elastic:YOUR-ELASTIC-PASSWORD http://YOUR-LOGGING-SERVER-IP:9200/esp32-logs-*/_count?pretty
