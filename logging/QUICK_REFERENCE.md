...
|---------|-----|-------------|
| Cribl | http://192.168.1.97:9000/ | claude / CiEtiNc65!k@gCG |
| Kibana | http://192.168.1.97:5601/ | elastic / N5l2MV3c |
| Elasticsearch | http://192.168.1.97:9200/ | elastic / N5l2MV3c |
...
# Recent logs
curl -u elastic:N5l2MV3c \
  "http://192.168.1.97:9200/esp32-logs-*/_search?pretty&size=10&sort=@timestamp:desc"

# Search for errors
curl -u elastic:N5l2MV3c \
  "http://192.168.1.97:9200/esp32-logs-*/_search?pretty&q=severity:error"
```
...
# Count alerts today
curl -u elastic:N5l2MV3c \
  "http://192.168.1.97:9200/esp32-alerts/_count?pretty&q=timestamp:>now-1d"
```
...
http://192.168.1.97:5601/app/discover

**Visualizations:**
http://192.168.1.97:5601/app/visualize
...
### No data in Kibana?
1. Check Cribl Live Data: http://192.168.1.97:9000/monitoring/live-data
...
1. Check for parse failures:
   ```bash
   curl -u elastic:N5l2MV3c \
     "http://192.168.1.97:9200/esp32-logs-*/_search?pretty&q=tags:parse_failure"
   ```
...
# Delete old one
curl -u elastic:N5l2MV3c \
  -X DELETE http://192.168.1.97:9200/esp32-logs-2025.12.01
```
