...
1. Navigate to **Data > Sources** in Cribl UI (http://192.168.1.97:9000/)
2. Click **Add Source**
3. Select **Syslog**
4. Configure:
   - **Input ID**: `syslog_udp`
...
4. Configure:
   ...
   - **Elasticsearch URL**: http://192.168.1.97:9200
   - **Auth Type**: Basic
   - **Username**: elastic
   - **Password**: N5l2MV3c
...
- Verify ESP32 is sending to correct IP (192.168.1.97:9514)
